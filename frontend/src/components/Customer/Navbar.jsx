...
export const Navbar = ({user,sidebarToggle,setSidebarToggle}) => {
  return (
    ...
    <div className='d-flex align-items-center'>
        ...
        <Link to='/customer/profile' className='text-decoration-none text-white'><div className='  d-flex ms-2 align-items-center cursor-pointer'><FaUserCircle style={{height:'20px',width:'20px'}}/><span className='px-1 d-none d-md-block d-flex' >Profile</span></div></Link>
    </div>
  </nav>
  )
}
